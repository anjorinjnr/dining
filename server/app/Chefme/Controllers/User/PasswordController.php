...
namespace Chefme\Controllers\User;

use \Chefme\Controllers\BaseController;
use Chefme\Validators\PasswordValidator;
use Chefme\Validators\ResetPasswordValidator;
...
class PasswordController extends BaseController {
    ...
    public function __construct(UserRepository $userRepository, \Chefme\Services\NotificationService $notificationService) {
