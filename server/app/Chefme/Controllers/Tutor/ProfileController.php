 ...
 * @author kayfun
 */
class ProfileController extends \Chefme\Controllers\BaseController {

    protected $studentService;
    protected $userRepository;

    public function __construct(StudentService $studentService, Chefme\Repository\UserRepository $userRepository) {
