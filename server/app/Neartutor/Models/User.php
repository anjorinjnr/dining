...
class User extends SentryUser implements UserInterface, RemindableInterface {
    ...
    public function tutor() {
        return $this->belongsTo('Neartutor\Models\Tutor', 'id', 'id');
    }

    public function student() {
        return $this->belongsTo('Neartutor\Models\Student', 'id', 'id');
    }
	
	public function outbox() {
        return $this->hasMany('Neartutor\Models\Message', 'id', 'id');
    }
